...
```
      ...
      --gallery-image-offer string         the gallery image offer to set (default "konvoy")
      --gallery-image-publisher string     the gallery image publisher to set (default "konvoy")
      --gallery-image-sku string           the gallery image sku to set
      --gallery-name string                the gallery name to publish the image in (default "konvoy")
  -h, --help                               help for azure
      ...
      --resource-group string              the resource group to create the image in (default "konvoy")
